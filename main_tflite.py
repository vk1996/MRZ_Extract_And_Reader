...
import cv2
import detector_inference_tflite
import numpy as np
...
doc_client=detector_inference_tflite.Detection(model_path='models/document_detector.tflite',
                                                classes_path='classes/document_classes.txt',
                                                grid=(16,16))

anglebracket_client=detector_inference_tflite.Detection(model_path='models/anglebracket_detector.tflite',
